...
#		progressInit()
                ...
                p('The data shown is from the input file provided, generated by DECoN version 1.0.0. If it\'s not what you\'re expecting, then first check that this is the correct file and that it has been generated according to the documentation.'),
